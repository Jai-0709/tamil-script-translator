...
```powershell
venv\Scripts\python.exe scripts\tools\check_dataset.py
```
...
venv\Scripts\python.exe scripts\tools\test_pipeline.py --image "data\testing\testing 2.jpg"
```
*(The annotated image will be saved as `outputs\test_output.jpg`).*
